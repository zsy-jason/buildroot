...
def main():
  ...
  parser.add_option('--manual-load-library', action='store_true', default=False, help='Load library manually.')
  ...
  # Loading library manually must set java_libraries_list empty
  java_libraries_list = '{}'
  if not options.manual_load_library:
