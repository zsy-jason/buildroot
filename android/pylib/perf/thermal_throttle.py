  ...
  def _ReadLog(self):
    ...
    for line in log:
      ...
      if temperature is not None:
        logging.info('Device %s thermally throttled at %3.1f%sC',
    ...
    if logging.getLogger().isEnabledFor(logging.DEBUG):
      ...
      if temperature is not None:
        logging.debug('Current SoC temperature of %s = %3.1f%sC',
                      serial_number, temperature, degree_symbol)
      ...
      for line in dumpsys_log:
        if 'temperature' in line:
          ...
          logging.debug('Current battery temperature of %s = %3.1f%sC',
